...
class Fraction_Test(unittest.TestCase):
    ...
    """unit test function to check simplified format of Fraction"""

    def test_simplified(self) -> None:
        a:Fraction=Fraction(-3,9)
        a=a.simplify()
        b:Fraction=Fraction(-1,3)
        self.assertEqual(str(a),str(b))
        self.assertEqual(str(Fraction(-2, -4).simplify()), "1/2")
        self.assertEqual(str(Fraction(4, -5).simplify()), "4/-5")
        self.assertEqual(str(Fraction(100, 2).simplify()), "50/1")
        self.assertEqual(str(Fraction(-90, 3).simplify()), "-30/1")
